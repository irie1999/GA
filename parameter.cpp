...
void Agent::set_parameter(bool *Gene){
    ...
    parameter_beta_1 =  bin2dec(0, N_bit_parameter_beta_1, Gene); /*始まりのビット、終わりのビット、遺伝子情報ビット*/
    parameter_beta_2 =  bin2dec(N_bit_parameter_beta_1,N_bit_parameter_beta_1 + N_bit_parameter_beta_2, Gene);
    parameter_h_prime_1 =  bin2dec(N_bit_parameter_beta_1 + N_bit_parameter_beta_2, N_bit_parameter_beta_1 + N_bit_parameter_beta_2 + N_bit_parameter_h_prime_1, Gene);
    parameter_h_prime_2 =  bin2dec(N_bit_parameter_beta_1 + N_bit_parameter_beta_2 + N_bit_parameter_h_prime_1, N_bit_parameter_beta_1 + N_bit_parameter_beta_2 + N_bit_parameter_h_prime_1 + N_bit_parameter_h_prime_2, Gene);
